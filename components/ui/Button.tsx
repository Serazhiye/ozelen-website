...
const base =
  "group inline-flex items-center justify-center gap-2.5 rounded-full font-medium tracking-tight transition-all duration-500 ease-out-expo focus-visible:outline-none disabled:opacity-50";
