...
export const milestones: { year: string; title: string; description: string }[] = [
  { year: "2021", title: "Основание", description: "Nord Botanic начинает работу с городского озеленения и тепличного производства." },
  { year: "2022", title: "Первые проекты", description: "Реализованы первые проекты озеленения общественных пространств." },
  { year: "2023", title: "Переход теплицы", description: "Тепличный комплекс начинает переход с цветов и тюльпанов на гидропонику." },
  { year: "2024", title: "Салаты круглый год", description: "Запуск круглогодичного производства салатов на гидропонике." },
  { year: "2025", title: "Рост команды", description: "Команда превышает 60 специалистов." },
  { year: "2026", title: "Более 11 проектов", description: "Реализовано свыше 11 проектов озеленения и благоустройства." },
];
...
export const awards: { year: string; title: string; body: string }[] = [
  { year: "2025", title: "За вклад в озеленение города", body: "Региональное признание" },
  { year: "2024", title: "Инновация в тепличном производстве", body: "Отраслевая премия" },
  { year: "2023", title: "Проект благоустройства года", body: "Городской конкурс" },
];
